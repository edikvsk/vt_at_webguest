...
def test_security_link_after_expiration_time(driver, logger):
    ...
    def add_security_account():
        start_time = old_time
        new_time = wg_page.get_current_time_formatted()
        expiration_time = wg_page.add_time(new_time, minutes=1)
